"""Retain positioned text from the held 2010 Panchayat Samiti result book.

This command only extracts words and their source coordinates. It does not
interpret table columns, reservation labels, people, or parties. The separate
parser consumes the JSON Lines artifact produced here.
"""
...
SOURCE = ROOT / "data/source/panchayat_samiti/panchayat_samiti_2010.pdf"
OUTPUT = ROOT / "data/extracted/panchayat_samiti_2010_pages.jsonl"
SOURCE_RELATIVE = "data/source/panchayat_samiti/panchayat_samiti_2010.pdf"
SOURCE_SHA256 = "e88f62d7e7172612310c66e73d90b475c2fb48494c57906fea6153dbce8c14c7"
FIRST_PAGE = 206
LAST_PAGE = 349
...
def extract(source, first_page=FIRST_PAGE, last_page=LAST_PAGE):
    ...
    with pdfplumber.open(source) as pdf:
        ...
        for source_page in range(first_page, last_page + 1):
            ...
            if source_page == first_page or source_page % 25 == 0:
                LOGGER.info(
